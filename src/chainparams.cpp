...
public:
    CMainParams() {
        ...
        //    CTxOut(empty
        //  vMerkleTree: 12630d1
     const char* pszTimestamp ="NeoCoin is launched reviving the altcoin market!.";
       CTransaction txNew;


       txNew.nTime = 1445312360;
       txNew.vin.resize(1);
        txNew.vout.resize(1);        txNew.vin[0].scriptSig = CScript() << 0 << CBigNum(42) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].SetEmpty();
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1445312360;
        genesis.nBits    = 520159231; 
        genesis.nNonce   = 95200;
